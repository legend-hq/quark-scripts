...
contract QuarkBuilderTransferTest is Test, QuarkBuilderTest {
    ...
    function testBridgeTransferMaxFundUnavailableError() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(QuarkBuilderBase.FundsUnavailable.selector, "USDC", 16.3e6, 12e6));
        builder.transfer(
    ...
    function testTransferIgnoresChainIfMaxCostIsNotSpecified() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(QuarkBuilderBase.FundsUnavailable.selector, "USDC", 5e6, 3e6));
        builder.transfer(
