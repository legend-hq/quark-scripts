...
contract BridgeTest is Test, QuarkBuilderTest {
        ...
        assertEq(
            ...
            abi.encodeCall(
                ...
                (
                    ...
                    1e18 * 1e18 / uint256(0.99e18), // inputAmount
                    1e18, // outputAmount
                    8453, // destinationChainId
                    address(0), // exclusiveRelayer
                    uint32(BLOCK_TIMESTAMP), // quoteTimestamp
                    uint32(BLOCK_TIMESTAMP + 600), // fillDeadline
        ...
        assertEq(
            ...
            abi.encode(
                Actions.BridgeActionContext({
                    ...
                    token: WETH_1,
                    assetSymbol: "WETH",
                    inputAmount: 1e18 * 1e18 / uint256(0.99e18),
                    outputAmount: 1e18,
                    chainId: 1,
